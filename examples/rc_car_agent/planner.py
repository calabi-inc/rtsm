...
_SYSTEM_PROMPT = (
    ...
    "marginal match costs seconds. When MORE THAN ONE candidate is a "
    "visually adequate match for the goal, pick the one listed FIRST "
    "(candidates arrive ranked by retrieval confidence) — never override "
    "the ranking because a lower-ranked crop looks more canonical; use "
    "confirmed status and stability only to break remaining ties. "
