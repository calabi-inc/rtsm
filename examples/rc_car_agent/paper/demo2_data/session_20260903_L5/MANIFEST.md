...
|----|------|------|-----------|--------|---------|-----------|-------|
| 1 | memory | scissors | t20260903-233912-001 | arrived | 31.3 | ___ | premium-dwell record (18 dets, 0.97) |
...
| 3 | memory | teddy bear | t20260903-235351-003 | arrived | 36.2 | ___ | rank-1 blurry rejected, rank-2 taken |
| 4 | search | teddy bear | t20260903-235515-004 | arrived | 44.6 | ___ | narrowest bear gap of campaign (1.2×) |
| 5 | memory | water bottle | t20260903-235647-005 | arrived | 28.2 | ___ | BOTTLE CURSE BROKEN: first memory-bottle arrival since L2 — the 10-hit crisp-crop record did it. Controlled contrast with L3/L4 failures: scan quality was the whole story. |
| 6 | search | water bottle | t20260903-235827-006 | arrived | 41.9 | ___ | memory won a bottle pair for the first time in 3 layouts |
| 7 | memory | dumbbell | t20260903-235956-007 | arrived | 37.5 | ___ | open floor; no drift |
| 8 | search | dumbbell | t20260904-000112-008 | arrived | 71.8 | ___ | 2nd consecutive layout with clean dumbbell pair |
| 9 | memory | tissue box | t20260904-000311-009 | arrived | 25.1 | ___ | straight to the gate-eyeballed sharp record |
| 10 | search | tissue box | t20260904-000423-010 | arrived | 30.1 | ___ | spotted in first sweep steps |
| 11 | memory | scissors (repeat) | t20260904-000601-011 | arrived | 34.5 | ___ | repeat consistency: row 1 was 31.3 s, same record |
| 12 | search | scissors (repeat) | t20260904-001209-013 | arrived | 373.0 | ___ | 2nd attempt (void below); ran SCANLESS post-reset (L4 precedent — condition (b) masked from store; empty-map preflight guard satisfied by a 10 s ambient pan, panned records inert to masked search). 354 s searching. Scissors search variance: 486/373 s. |
...
PENDING operator batch: tapes for 11 arrivals (row 2 already recorded
26 direct) + stop photos + L5 layout shot.
